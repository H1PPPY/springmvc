...
public class UpAndDownAction {
    ...
    public void fileDownloadServlet(@RequestParam("filename") String filename, HttpServletRequest request, HttpServletResponse response) {
